  ...
  return (
    <section className="bg-white py-16 px-6 md:py-24">
      <div className="container mx-auto">
        ...
        <div className="bg-[#F9F9FB] grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 mb-20  md:p-12 w-full ">
          ...
          <div className="flex items-center ">
            <div className="border-l-[5px] border-[#C4C4C426] pl-7 font-inter font-normal text-[18px] leading-[160%] tracking-[0.02em] text-black/50">
              <p>
                Semper bibendum nisl, fermentum mi convallis. Sed vitae
                tincidunt nunc, aliquam orci. Porttitor faucibus morbi sed
                senectus justo, adipiscing augue. Est, in in pretium at libero
                morbi. Euismod viverra arcu nisi eu sit. <br />
                <br />
